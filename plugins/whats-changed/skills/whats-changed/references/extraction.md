...
The reading half of `whats-changed`. Read it before comparing anything.

The monthly pack usually reaches the person who needs this skill as **a deck or a PDF**, not
as the source workbook — the workbook stayed with whoever built it. So extraction is a real
step, not a detail, and some pairs are genuinely lower-fidelity than others. Say which;
never imply parity.
