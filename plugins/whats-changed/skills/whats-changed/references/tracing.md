...
| **"You said flat — but Payroll moved £6k."** | The mode first: total moved −0.3% (< 1%), so the flat-mode bar applies — 1% of the prior total, e.g. 6 < 25. Then that 5% of an £8k movement would have been 0.4, which is why the normal gate isn't used when the total is flat. |
